...
/// 🧠 스마트 셰르피 매니저 (정적 메시지 전용 버전)
/// 
/// AI 시스템이 완전히 비활성화되고 정적 메시지만 사용하는 간소화된 버전입니다.
class SmartSherpiManager {
  ...
  /// 
  /// AI 시스템이 비활성화되어 항상 정적 메시지를 즉시 반환합니다.
    ...
    switch (_personalizationSettings.personalityType) {
      case SherpiPersonalityType.energetic:
        return {
          ...
          SherpiContext.readingComplete: '공부 완료!! ${_personalizationSettings.userPreferredName}님 대단해요!! 📚🌟',
      ...
      case SherpiPersonalityType.calm:
        return {
          ...
          SherpiContext.readingComplete: '학습을 마치셨네요. ${_personalizationSettings.userPreferredName}님의 지식이 깊어지고 있습니다. 📖',
      ...
      case SherpiPersonalityType.humorous:
        return {
          ...
          SherpiContext.readingComplete: '공부 끝! ${_personalizationSettings.userPreferredName}님 뇌가 빛나고 있어요! 번쩍번쩍! 🧠✨',
      ...
      case SherpiPersonalityType.serious:
        return {
          ...
          SherpiContext.readingComplete: '학습 목표를 달성하셨습니다. ${_personalizationSettings.userPreferredName}님의 지식 습득률이 향상되고 있습니다. 📚',
      ...
      default: // balanced
        return {
          ...
          SherpiContext.readingComplete: '공부 완료! ${_personalizationSettings.userPreferredName}님 정말 열심히 하셨네요! 📚',
...
class SherpiResponse {
  ...
  /// 💾 캐시 히트 여부 (항상 false - 캐시 사용 안 함)
  bool get isCacheHit => false;
}
