...
class SmartSherpiManager {
  ...
  // AI 소스
  OpenAIDialogueSource? _openaiSource;
  ...
  Future<SherpiResponse> getMessage(
    ...
    // 게임 컨텍스트에 개인화 설정 추가
    if (gameContext != null) {
      gameContext['personalityType'] = _personalizationSettings.personalityType.displayName;
      gameContext['userPreferredName'] = _personalizationSettings.userPreferredName;
    }
    
    // 1. 캐시 확인
    final cachedMessage = await _cache.getCachedMessage(context, userContext ?? {});
    ...
    switch (_personalizationSettings.personalityType) {
      case SherpiPersonalityType.energetic:
        return {
          ...
          SherpiContext.readingComplete: '독서 완료!! ${_personalizationSettings.userPreferredName}님 대단해요!! 📚🌟',
      ...
      case SherpiPersonalityType.calm:
        return {
          ...
          SherpiContext.readingComplete: '독서를 마치셨네요. ${_personalizationSettings.userPreferredName}님의 지식이 깊어지고 있습니다. 📖',
      ...
      case SherpiPersonalityType.humorous:
        return {
          ...
          SherpiContext.readingComplete: '독서 끝! ${_personalizationSettings.userPreferredName}님 마음이 풍요로워지고 있어요! 📚✨',
          ...
          SherpiContext.allGoalsComplete: '전부 클리어! 오늘 ${_personalizationSettings.userPreferredName}님은 신이에요! 🎊🙌',
        };
      case SherpiPersonalityType.serious:
        return {
          ...
          SherpiContext.readingComplete: '독서 목표를 달성하셨습니다. ${_personalizationSettings.userPreferredName}님의 지식 습득률이 향상되고 있습니다. 📚',
      ...
      default: // balanced
        return {
          ...
          SherpiContext.readingComplete: '독서 완료! ${_personalizationSettings.userPreferredName}님 정말 열심히 하셨네요! 📚',
          ...
          SherpiContext.general: '${_personalizationSettings.userPreferredName}님과 함께해서 즐거워요! 😊',
...
class SherpiResponse {
  ...
  /// ⚡ 빠른 응답인지 확인
  bool get isFastResponse => source == MessageSource.static || source == MessageSource.aiCached;
