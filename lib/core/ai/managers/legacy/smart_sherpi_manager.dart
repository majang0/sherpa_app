...
class SmartSherpiManager {
  ...
  Future<SherpiResponse> getMessage(
    ...
    // 항상 정적 메시지만 반환
    return Future.value(
        _getStaticMessageSync(context, userContext, gameContext));
  }
    ...
    switch (_personalizationSettings.personalityType) {
      case SherpiPersonalityType.energetic:
        return {
          ...
          SherpiContext.readingComplete:
              '공부 완료!! ${_personalizationSettings.userPreferredName}님 대단해요!! 📚🌟',
      ...
      case SherpiPersonalityType.calm:
        return {
          ...
          SherpiContext.readingComplete:
              '학습을 마치셨네요. ${_personalizationSettings.userPreferredName}님의 지식이 깊어지고 있습니다. 📖',
      ...
      case SherpiPersonalityType.humorous:
        return {
          ...
          SherpiContext.readingComplete:
              '공부 끝! ${_personalizationSettings.userPreferredName}님 뇌가 빛나고 있어요! 번쩍번쩍! 🧠✨',
      ...
      case SherpiPersonalityType.serious:
        return {
          ...
          SherpiContext.readingComplete:
              '학습 목표를 달성하셨습니다. ${_personalizationSettings.userPreferredName}님의 지식 습득률이 향상되고 있습니다. 📚',
      ...
      default: // balanced
        return {
          ...
          SherpiContext.readingComplete:
              '공부 완료! ${_personalizationSettings.userPreferredName}님 정말 열심히 하셨네요! 📚',
