...
class MeetingImageCacheManager {
  static final MeetingImageCacheManager _instance = MeetingImageCacheManager._internal();
  ...
  Map<String, dynamic> getCacheStats() {
    return {
      ...
      'memoryUsage': '${(_currentMemoryUsage / 1024 / 1024).toStringAsFixed(2)} MB',
      'hitCounts': _cacheHitCount,
      'oldestCache': _cacheTimestamps.isNotEmpty 
        ? _cacheTimestamps.entries.reduce((a, b) => 
