// lib/features/meetings/presentation/widgets/meeting_creation/details_form_step.dart
...
/// 📝 상세 정보 입력 폼 - Step 2
/// 제목, 설명, 장소, 인원, 참가비, 태그, 준비물, 이미지 등 모든 정보를 입력하는 메인 폼
class QuickDetailsForm extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<QuickDetailsForm> createState() => QuickDetailsFormState();
}

class QuickDetailsFormState extends ConsumerState<QuickDetailsForm> {
