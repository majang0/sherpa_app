...
class UserActivityPattern {
  ...
  String get activitySummary {
    ...
    if (meetingPattern.averagePerWeek > 0) {
      activities
          .add('모임 주 ${meetingPattern.averagePerWeek.toStringAsFixed(1)}회');
    }
...
class ReadingPattern {
  ...
  String get description {
    ...
    final categoryStr =
        mainCategories.isNotEmpty ? mainCategories.join(', ') : '다양한 장르';
...
class MeetingPattern {
  ...
  String get description {
    ...
    final categoryStr =
        preferredCategories.isNotEmpty ? preferredCategories.first : '다양한 모임';
...
class MoviePattern {
  ...
  String get description {
    ...
    final genreStr =
        preferredGenres.isNotEmpty ? preferredGenres.join(', ') : '다양한 장르';
