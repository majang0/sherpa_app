...
class EmotionAnalysisService {
  ...
  EmotionAnalysisResult analyzeUserEmotion(EmotionAnalysisContext context) {
    ...
    final primaryEmotion =
        emotionScores.entries.reduce((a, b) => a.value > b.value ? a : b).key;
    ...
    return EmotionAnalysisResult(
      ...
      emotionScores: emotionScores
          .map((key, value) => MapEntry(key, (value / 100.0).clamp(0.0, 1.0))),
  ...
  void _analyzeActivityOutcome(
      EmotionAnalysisContext context, Map<UserEmotionState, double> scores) {
    if (context.isSuccess) {
      // 성공 시 감정 분포
      switch (context.activityType) {
        case 'exercise':
          scores[UserEmotionState.positive] =
              scores[UserEmotionState.positive]! + 35;
          scores[UserEmotionState.motivated] =
              scores[UserEmotionState.motivated]! + 25;
          if (context.consecutiveDays >= 7) {
            scores[UserEmotionState.excited] =
                scores[UserEmotionState.excited]! + 15;
          }
          break;
        ...
        case 'reading':
          scores[UserEmotionState.positive] =
              scores[UserEmotionState.positive]! + 30;
          scores[UserEmotionState.contemplative] =
              scores[UserEmotionState.contemplative]! + 20;
          scores[UserEmotionState.motivated] =
              scores[UserEmotionState.motivated]! + 10;
          break;

        case 'quest':
          scores[UserEmotionState.excited] =
              scores[UserEmotionState.excited]! + 25;
          scores[UserEmotionState.positive] =
              scores[UserEmotionState.positive]! + 20;
          scores[UserEmotionState.motivated] =
              scores[UserEmotionState.motivated]! + 15;
          break;

        case 'climbing':
          scores[UserEmotionState.excited] =
              scores[UserEmotionState.excited]! + 30;
          scores[UserEmotionState.positive] =
              scores[UserEmotionState.positive]! + 25;
          break;

        default:
          scores[UserEmotionState.positive] =
              scores[UserEmotionState.positive]! + 25;
          scores[UserEmotionState.neutral] =
              scores[UserEmotionState.neutral]! + 15;
      }
    } else {
      // 실패 시 감정 분포 (더 세밀한 분석)
      final failureContext =
          context.performanceData['failure_reason'] as String?;

      if (failureContext == 'time_constraint') {
        scores[UserEmotionState.stressed] =
            scores[UserEmotionState.stressed]! + 20;
        scores[UserEmotionState.tired] = scores[UserEmotionState.tired]! + 15;
      } else if (failureContext == 'difficulty') {
        scores[UserEmotionState.contemplative] =
            scores[UserEmotionState.contemplative]! + 20;
        scores[UserEmotionState.negative] =
            scores[UserEmotionState.negative]! + 10;
      } else {
        scores[UserEmotionState.negative] =
            scores[UserEmotionState.negative]! + 15;
        scores[UserEmotionState.neutral] =
            scores[UserEmotionState.neutral]! + 10;
      }
    }
  }
  ...
  void _analyzeConsistencyPattern(
    ...
    if (context.consecutiveDays >= 30) {
      ...
      scores[UserEmotionState.motivated] =
          scores[UserEmotionState.motivated]! + 15;
      scores[UserEmotionState.positive] =
          scores[UserEmotionState.positive]! + 10;
      ...
      scores[UserEmotionState.motivated] =
          scores[UserEmotionState.motivated]! + 10;
      scores[UserEmotionState.positive] =
          scores[UserEmotionState.positive]! + 8;
    } else if (context.consecutiveDays >= 3) {
      // 3일 이상 연속: 시작 단계
      scores[UserEmotionState.motivated] =
          scores[UserEmotionState.motivated]! + 5;
      ...
      scores[UserEmotionState.negative] =
          scores[UserEmotionState.negative]! + 10;
      scores[UserEmotionState.contemplative] =
          scores[UserEmotionState.contemplative]! + 8;
    }
  }
    ...
    switch (context.timeOfDay) {
      case >= 6 && < 9:
        ...
        scores[UserEmotionState.motivated] =
            scores[UserEmotionState.motivated]! + 10;
        scores[UserEmotionState.positive] =
            scores[UserEmotionState.positive]! + 5;
        break;
      ...
      case >= 9 && < 12:
        ...
        scores[UserEmotionState.contemplative] =
            scores[UserEmotionState.contemplative]! + 8;
        scores[UserEmotionState.motivated] =
            scores[UserEmotionState.motivated]! + 7;
        break;
      ...
      case >= 18 && < 22:
        // 저녁 시간대: 편안함
        scores[UserEmotionState.neutral] =
            scores[UserEmotionState.neutral]! + 8;
        scores[UserEmotionState.positive] =
            scores[UserEmotionState.positive]! + 7;
        break;
      ...
      case >= 22 || < 6:
        ...
        scores[UserEmotionState.tired] = scores[UserEmotionState.tired]! + 15;
        scores[UserEmotionState.contemplative] =
            scores[UserEmotionState.contemplative]! + 5;
        break;
    }
  ...
  void _analyzeRecentActivityPattern(
    ...
    if (recentActivities.length >= 5) {
      // 활발한 활동: 동기부여 상승
      scores[UserEmotionState.motivated] =
          scores[UserEmotionState.motivated]! + 8;
      scores[UserEmotionState.positive] =
          scores[UserEmotionState.positive]! + 5;
  ...
  void _analyzePerformanceData(
    ...
    switch (trend) {
      ...
      case 'declining':
        scores[UserEmotionState.negative] =
            scores[UserEmotionState.negative]! + 8;
        scores[UserEmotionState.contemplative] =
            scores[UserEmotionState.contemplative]! + 5;
        break;
      case 'stable':
        scores[UserEmotionState.neutral] =
            scores[UserEmotionState.neutral]! + 5;
        break;
    }
    ...
    if (achievementRate != null) {
      if (achievementRate >= 0.8) {
        scores[UserEmotionState.excited] =
            scores[UserEmotionState.excited]! + 5;
      } else if (achievementRate <= 0.3) {
        scores[UserEmotionState.stressed] =
            scores[UserEmotionState.stressed]! + 5;
      }
    }
  }
  ...
  bool _isNeutralMatch(SherpiEmotion actual, SherpiEmotion recommended) {
    ...
    return neutralEmotions.contains(actual) ||
        neutralEmotions.contains(recommended);
  }
